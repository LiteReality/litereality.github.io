...
| Folder | URL | What |
|---|---|---|
| `/` | https://litereality.github.io/ | LiteReality project page |
| `agent/` | https://litereality.github.io/agent/ | LiteReality-Agent landing page, blog post (`agent/litereality-agent-post/`), VR walkthrough viewer (`agent/vr/`) |
